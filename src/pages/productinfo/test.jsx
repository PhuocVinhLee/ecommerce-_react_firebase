...
function ProductInfo() {
    ...
    const { loading, setLoading,  reviews,getReviewDate } = context;
    ...
    const addCart = (products) => {
        console
        dispatch(addToCart({ products, productNumber: 1 }))
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex justify-between">
                                ...
                                <button  onClick={()=>addCart(products)} className="bg-primary  hover:scale-105 duration-300 text-white py-1 px-4 rounded-full  group-hover:bg-white group-hover:text-primary">
                                    Add To Cart
                                </button>
