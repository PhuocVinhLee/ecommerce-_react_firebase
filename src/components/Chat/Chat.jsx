...
function Chat() {
  ...
  return (
    <div>
      ...
      >
        <div class="  flex-1 p:2 sm:p-3 justify-start  flex flex-col  h-[500px] bg-white  dark:bg-black dark:text-white shadow-lg rounded">
          <div class="   flex flex-col gap-y-1  py-0 border-b-2  border-gray-200">
            <div class=" max-w-[700px] overflow-x-auto gap-1 flex items-center space-x-2 border-b-2 border-gray-200 pb-2">
              {user?.map((item, index) => {
                return (
                  <div>
                    ...
                    <div class="relative flex items-center space-x-4">
                      ...
                      <div class="flex flex-col leading-tight">
                        ...
                        <div class="text-2xl m flex items-center">
                          <span class=" mr-3 text-[17px] font-bold">
                            {
